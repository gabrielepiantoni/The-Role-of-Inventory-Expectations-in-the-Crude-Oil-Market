% FIGURE3_QUAD_FINAL_CORRECTED.M
...
% 4. ExpInv (LogLevel)
%
% SHOCK ORDER (rows of IRF):
% 1. Oil supply shock                    -> NEGATIVE
% 2. Aggregate demand shock              -> POSITIVE
% 3. Oil-specific residual demand shock  -> POSITIVE
% 4. Oil-specific precautionary demand   -> NEGATIVE

clear;
quadvar_inverted;   % y = [Prod, REA, Price, ExpInv]
