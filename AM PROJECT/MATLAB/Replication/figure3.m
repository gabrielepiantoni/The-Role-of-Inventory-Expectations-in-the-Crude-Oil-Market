...
% Impulse Response Functions from the baseline monthly SVAR
% Structural shocks: oil supply, aggregate demand, oil-specific demand
% Confidence intervals obtained via wild bootstrap
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Bootstrap procedure for confidence intervals (recursive-design wild bootstrap)
randn('seed',1234);
nrep = 2000;
...
for r = 1:nrep
    ...
    % Wild bootstrap shocks (common multiplier across equations)
